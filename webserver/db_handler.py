...
if __name__ == '__main__':
    ...
    db.insert_domain_topn('default', '20130819000000',[['baidu.com', 100]] )
    db.insert_ip_topn('default', '20130817000000',[['203.119.80.40', 100]] )
    db.insert_ip_topn('*', '20130818000000',[['202.118.81.50', 100]] )
    db.insert_ip_topn('default', '20130818000000',[['202.118.81.50', 100]] )
    db.insert_ip_topn('default', '20130818000000',[['202.118.81.50', 100]] )
    db.insert_ip_topn('default', '20130818000000',[['203.119.80.40', 100]] )
    db.insert_one_day_ip_topn('default', '20130816000000',[['202.118.82.50', 100]] )
    db.insert_one_day_ip_topn('default', '20130816000000',[['202.118.81.50', 300]] )

    db.insert_rcode('default', '20130817000000', [["nxdomain", 100]])
    db.insert_rtype('default', '20130817000000', [["A", 100],["AAAA",200]])
    db.insert_rcode('default', '20130818000000', [["nxdomain", 100]])
    db.insert_rtype('default', '20130818000000', [["A", 100],["AAAA",200]])
    db.insert_one_day_rcode('default', '20130816000000', [["nxdomain", 100]])
    db.insert_one_day_rtype('default', '20130816000000', [["A", 100],["AAAA",200]])
    #db.commit()
    db._get_latest_time('iptopn')
    print db.get_rcode('default', '20130815000000', '20130828000000')
    print db.get_rtype('default', '20130815000000', '20130828000000')
    print db.get_ip_topn('*', '20130815200427', '20130821200427', 10)
    print db.get_domain_topn('*', '20130815200427', '20130821200427', 10)
    db.insert_ip_topn('default', '20130817000000',[['.40', 100]] )
    print db.get_ip_topn('default', '20130815200427', '20130821200427', 10)
    print db._less_than_some_interval('20130811000000','20130817000000', TIME_INTERVAL)
    db.insert_qps('default', '20130817000000', 100.234)
    print db.get_qps('default', '20130817000000', '20130900020101')
    db.insert_success_rate('default', '20130817000000', 0.234)
    print db.get_success_rate('default', '20130817000000', '20130900020101')
    db.insert_nic_rate('eth0', '20130817000000', 100.234, 200.02)
    print "nic rate", db.get_nic_rate('eth0', '20130817000000', '20130900020101')
    db.commit()
    db._get_latest_time('iptopn')
    print db.get_ip_topn('default', '20130815200427', '20130821200427', 10)
    db.insert_ip_topn('default', '20130817000000',[['.40', 100]] )
